...
async function enviarFormulario() {
  ...
  sucesso.value = ''
  try {
    await criarUsuario({ usuario: usuario.value,nome: nome.value, email: email.value, senha: senha.value })
...
<template>
  <div>
    ...
    <form @submit.prevent="enviarFormulario">
      <input v-model="usuario" type="text" placeholder="Usuário" required />
